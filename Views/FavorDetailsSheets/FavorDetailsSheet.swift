...
//                dismiss()
        ...
        .sheet(isPresented: $isEditFavorSheetPresented, content: {
            EditFavorSheet(isPresented: $isEditFavorSheetPresented, database: database, viewModel: viewModel, editFavorId: favor.id, selectedFavor: $selectedFavor, showEditedFavorOverlay: $showInteractedFavorOverlay, lastFavor: $lastFavorInteracted, lastInteraction: $lastInteraction, favor: $favor)
        })
