    ...
    ScrollView {
        ...
        LazyVGrid(columns: [.init(.adaptive(minimum: 100), spacing: 10)]) {
            ForEach(FavorCategory.allCases) { category in
                ...
                FavorMarker(favor: .init(title: "Test", description: "Test", author: .init(nameSurname: .constant("Name Surname"), neighbourhood: .constant("Città Studi"), profilePictureColor: .constant("blue")), neighbourhood: "Città Studi", type: .individual, location: MapDetails.startingLocation, isCarNecessary: false, isHeavyTask: false, status: .ongoing, category: category), isSelected: .constant(false), isInFavorSheet: true, isOwner: false)
                    .padding(.bottom, 50)
        ...
        LazyVGrid(columns: [.init(.adaptive(minimum: 100), spacing: 10)]) {
            ForEach(FavorCategory.allCases) { category in
                ...
                FavorMarker(favor: .init(title: "Test", description: "Test", author: .init(nameSurname: .constant("Name Surname"), neighbourhood: .constant("Città Studi"), profilePictureColor: .constant("blue")), neighbourhood: "Città Studi", type: .individual, location: MapDetails.startingLocation, isCarNecessary: false, isHeavyTask: false, status: .ongoing, category: category), isSelected: .constant(true), isInFavorSheet: true, isOwner: true)
                    .padding(.bottom, 50)
            }
        }
        .padding(.top, 50)
        ...
        LazyVGrid(columns: [.init(.adaptive(minimum: 100), spacing: 10)]) {
            ForEach(FavorCategory.allCases) { category in
                ...
                FavorMarker(favor: .init(title: "Test", description: "Test", author: .init(nameSurname: .constant("Name Surname"), neighbourhood: .constant("Città Studi"), profilePictureColor: .constant("blue")), neighbourhood: "Città Studi", type: .individual, location: MapDetails.startingLocation, isCarNecessary: false, isHeavyTask: false, status: .ongoing, category: category), isSelected: .constant(false), isInFavorSheet: true, isOwner: true)
                    .padding(.bottom, 50)
